...
<title>Client Dashboard - Allergen Checker</title>
...
<div class="dashboard">
    <div class="header">
        <h1>🍔 Allergen Checker - Client Dashboard</h1>
        <a href="logout.php" class="logout-btn">Logout</a>
    </div>

    <div class="cards-container">
        <a href="client_profile.php" class="card">
            <div class="card-icon">👤</div>
            <h3>My Profile</h3>
            <p>View and edit your personal information and manage your allergies</p>
        </a>

        <a href="kiosk.php" class="card">
            <div class="card-icon">🛒</div>
            <h3>Order Food</h3>
            <p>Browse and order food items with real-time allergen checking</p>
        </a>

        <a href="client_orders.php" class="card">
            <div class="card-icon">📦</div>
            <h3>My Orders</h3>
            <p>View your order status and history, cancel orders if needed</p>
        </a>
    </div>
</div>
